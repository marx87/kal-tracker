...
void main() {
  test(
    'il filtro categoria mostra anche i piatti oltre il limite di default',
    () async {
      AppTime.initialize();
      ...
      container.read(foodCategoryFilterProvider.notifier).state =
          'Primi piatti';
      ...
      expect(visible.map((food) => food.name), contains('Piatto 59'));
    },
  );
}
